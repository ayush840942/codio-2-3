...
const SubscriptionPlanCard: React.FC<SubscriptionPlanCardProps> = ({
  ...
  return (
    <Card 
      className={`relative h-full transition-all duration-300 hover:shadow-lg w-full max-w-full ${
        plan.popular 
    ...
    >
      ...
      <CardFooter className="pt-4 px-4 sm:px-6">
        <Button 
          ...
          className={`w-full font-medium transition-all text-sm sm:text-base ${
            plan.popular 
