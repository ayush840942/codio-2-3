...
const CodeResult = () => {
  ...
  if (!currentLevel || !code || !levelExplanations) {
    return (
      <div className="min-h-[100dvh] bg-puzzle-light">
        <NavBar />
        <div className="min-h-[100dvh] flex flex-col items-center justify-center p-4 text-center bg-background" style={{ paddingTop: 'calc(var(--safe-area-top) + 3.5rem)' }}>
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-puzzle-light via-white to-puzzle-purple/5">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6" style={{ paddingTop: 'calc(var(--safe-area-top) + 3.5rem)' }}>
