...
export const htmlLearningContent: Record<string, LevelLearningContent> = {
  '1': {
    ...
    icon: BookOpen,
    introduction: "Welcome, Apprentice! 🐱‍💻 You've just entered the 'Hacker Cat' terminal. HTML is the skeleton of your site. Without it, you're just floating text in the void. Ready to build a spine?",
    objectives: [
    ...
    summary: "Purr-fect! Level 1 clear. The Hacker Cat is impressed. Your skeleton is looking sturdy—no more floppy sites!",
  },
  '2': {
    topic: 'HTML',
    title: 'HTML Attributes: Adding Information to Elements',
    icon: Code2,
    introduction: "Attributes are like adjectives for your code. They tell the browser *more* — like 'This cat is small' vs 'This cat is a hacker'. Let's spice things up!",
    objectives: [
