...
export const codingPuzzles: CodingPuzzle[] = [
  ...
  // ==========================================
  // ⚡ CODE THE PHYSICAL WORLD Puzzles
  // ==========================================
  {
    id: 9901,
    title: "Vibrate Your Phone",
    level: "Device Magic",
    concept: "Capacitor Haptics",
    description: "Write code that literally makes your phone vibrate in your hand! Use the built-in DeviceMagic API.",
    expectedOutput: "BZZZ! Device vibrated.",
    starterCode: "// Call the global DeviceMagic API to vibrate your phone\nawait DeviceMagic.___;",
    answerCode: "await DeviceMagic.vibrate();"
  },
  {
    id: 9902,
    title: "Light in the Dark",
    level: "Device Magic",
    concept: "Camera Flash",
    description: "Turn on your phone's flashlight using JavaScript! (Simulated in this web environment via screen flash)",
    expectedOutput: "Flashlight triggered!",
    starterCode: "// Use DeviceMagic to trigger the flashScreen method\nDeviceMagic.___;",
    answerCode: "DeviceMagic.flashScreen();"
  },
  {
    id: 9903,
    ...
    description: "Fetch your exact GPS coordinates using the phone's hardware.",
    expectedOutput: "", // Output varies based on location, sandbox will handle verification based on existence of lat/lng
    starterCode: "// Await the coordinates from DeviceMagic\nconst coords = await DeviceMagic.___; \nprint(`Lat: ${coords.lat}, Lng: ${coords.lng}`);",
    answerCode: "const coords = await DeviceMagic.getCoordinates();\nprint(`Lat: ${coords.lat}, Lng: ${coords.lng}`);"
  }
];
